...
A single-page prototype presenting health & anthropology field notes. Purely presentational — no database, no auth, no forms. All content is hardcoded in `src/routes/index.tsx`. Built with TanStack Start and deployed on Netlify.
